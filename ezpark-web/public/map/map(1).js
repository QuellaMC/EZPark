...
function applyZoom() {
    ...
    movingElements.forEach(element => {
        ...
        const scaledLeft = (initialLeft * scaleFactor - cropX) * scale;
        const scaledTop = (initialTop * scaleFactor - cropY) * scale;

        element.style.transform = `translate(${scaledLeft - offsetX}px, ${scaledTop - offsetY}px) scale(${scale})`;
    });
}
